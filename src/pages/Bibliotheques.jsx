    ...
    <div className="divArticles">
          ...
          <Select
            ...
            styles={{
              control: (base, state) => ({
                ...
                borderColor: state.isFocused || state.isHovered ? '#4B0F0B' : base.borderColor,
                boxShadow: state.isFocused  || state.isHovered ? '0 0 0 1px #4B0F0B' : base.boxShadow,
              }),
              menu: (base) => ({
                ...base,
                margin: 0,
              ...
              option: (base, state) => ({
                ...base,
                cursor: 'pointer',
                backgroundColor: state.isFocused ? '#4B0F0B' : base.backgroundColor,
                color: state.isFocused ? 'white' : base.color,
              }),
              multiValue: (base) => ({
                ...base,
                maxWidth: '30%',
                backgroundColor: '#4B0F0B',
                color: "#F6EBE2"
              }),
          ...
          <Select
            ...
            styles={{
              control: (base, state) => ({
                ...
                backgroundColor: '#F6EBE2',
                border: '1px solid #4B0F0B',
                borderColor: (state.isFocused || state.isHovered) || (state.isSelected) ? '#4B0F0B' : base.borderColor,
                boxShadow: state.isFocused || state.isHovered ? '0 0 0 1px #4B0F0B' : base.boxShadow,
              }),
              menu: (base) => ({
                ...base,
      ...
      <div className='listArticles'>
        {filterArticles().slice(0, visibleArticles).map(article => (
          <Link to={`/oneAnnexe/${article.id_annexe}`} key={article.id_annexe}>
            <div className='itemArticle annexeItem'>
